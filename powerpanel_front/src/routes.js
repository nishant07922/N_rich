...
const routes = [
  ...
  { path: '/dashboard', name: 'Dashboard', element: Dashboard , permission:'edit rolespermission' },
  ...
  { path: '/roles', name: 'Roles', element: Roles, permission:'edit rolespermission' },
  { path: '/roles/add', name: 'Add Roles', element: RolesAdd, permission:'edit rolespermission' },
  { path: '/roles/edit', name: 'Edit Roles', element: RolesEdit, permission:'edit rolespermission' },
  { path: '/roles/edit/:role_id', name: 'Edit Roles', element: RolesEdit, permission:'edit rolespermission' },
  { path: '/rolepermission/add', name: 'Add Roles Permission', element: RolesPermissionAdd, permission:'edit rolespermission' },
  { path: '/rolepermission/edit', name: 'Edit Roles Permission', element: RolesPermissionEdit, permission:'edit rolespermission' },
  { path: '/rolepermission/edit/:role_permission_id', name: 'Edit Roles Permission', element: RolesPermissionEdit, permission:'edit rolespermission' },
  { path: '/users', name: 'Users', element: Users, permission:'edit rolespermission' },
