...
const routes = [
  ...
  { path: '/roles/add', name: 'Add Roles', element: RolesAdd },
  { path: '/roles/edit', name: 'Edit Roles', element: RolesEdit },
  { path: '/roles/edit/:role_id', name: 'Edit Roles', element: RolesEdit },
